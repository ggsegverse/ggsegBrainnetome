...
- `data/*.rda` – `ggseg_atlas` objects (2D polygon geometry)
- `R/brainnetome.R` – Roxygen2 documentation for the atlas
- `R/ggsegBrainnetome-package.R` – Package-level docs, imports
  ggseg.formats
...
`ggseg_atlas` class. This atlas provides 2D data for
[`ggseg::geom_brain()`](https://ggsegverse.github.io/ggseg/reference/ggbrain.html)
only (no 3D vertex data).
